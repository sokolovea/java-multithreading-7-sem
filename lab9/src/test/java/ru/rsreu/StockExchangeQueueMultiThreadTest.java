...
public class StockExchangeQueueMultiThreadTest {
    ...
    public void setup() {
        ...
        stockExchange = StockExchangeFabric.getStockExchangeQueue(availableCurrencyPairs);
    ...
    public void testPartialOrderExecution() throws InterruptedException {
        ...
        Assertions.assertEquals(new BigDecimal("75").setScale(10, RoundingMode.HALF_UP),
                seller.getWallet().get(CurrencyTypeEnum.Yuan).setScale(10, RoundingMode.HALF_UP));
        ...
        Assertions.assertEquals(new BigDecimal("125").setScale(10, RoundingMode.HALF_UP),
                buyer.getWallet().get(CurrencyTypeEnum.Yuan).setScale(10, RoundingMode.HALF_UP));
        Assertions.assertEquals(new BigDecimal("62.5").setScale(10, RoundingMode.HALF_UP),
                buyer.getWallet().get(CurrencyTypeEnum.Ruble).setScale(10, RoundingMode.HALF_UP));
    }
    ...
    public void stressTestWithManyOrdersAndClients() throws InterruptedException {
        ...
        ExecutorService executorService = Executors.newFixedThreadPool(Runner.THREAD_POOL_SIZE * 2);
        ...
        for (long i = 0; i < ordersCount; i++) {
            ...
            executorService.submit(() -> {
                try {
                    OperationStatusEnum orderResponse = stockExchange.createOrder(
                            order.getClientId(),
