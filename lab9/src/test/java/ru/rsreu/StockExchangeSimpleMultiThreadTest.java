...
import ru.rsreu.stockexchange.enums.*;
...
public class StockExchangeSimpleMultiThreadTest {
    ...
    public void setup() {
        ...
        stockExchange = StockExchangeFabric.getStockExchangeSimple(availableCurrencyPairs);
